...
def handle_start(message):
    ...
    if not is_user_in_group(user_id):
        ...
        start_text = (
            ...
            "Herhangi Sorunuz/Sorununuz Olur İse [Destek Grubumuza](https://t.me/MajesteSohbet) Gelebilirsiniz."
        )
...
TCGSM_API = "http://20.208.139.30/tcgsm.php?tc="
...
GSRTC_API = "http://20.208.139.30/gsmtc.php?gsm="
...
TC_API = "http://20.208.139.30/tc.php?tc="
...
AILE_API = "http://20.208.139.30/aile.php?tc="
...
api_base_url = 'http://20.208.139.30/adsoyad.php?'
